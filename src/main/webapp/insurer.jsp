    ...
    <body>
        ...
        <nav class="navbar navbar-light bg-light static-top">
            <div class="container">
                ...
                <div class="col-md-1" >
                <a class="navbar-brand" href="EOA.jsp"><button class="btn btn-primary" href="signup.html" id="button-submit" type="button">設置醫療院所EOA</button></a>
                </div>
            </div>
        </nav>
        <!-- Masthead-->
                ...
                <div class="row justify-content-center">
                    <div class="col-xl-8">
                        <div class="text-center text-white">
                            ...
                            <h3 class="mb-5">歡迎使用本系統，是否開始監聽區塊鏈智能合約事件</h3>
                            <div class="text-center text-white">
                                <div class="panel-heading"><h5>本次監聽智能合約:</h5>
		                            <div class="panel-body">
			                        <label class="radio-inline" style="font-size:20px text-center">
				                        <input id="normalDeploy" type="radio" name="rdoMode" value="normal" checked="checked">防疫​保單(預設)<br>
                                ...
                                <input class="btn btn-primary" type ="submit" value="確認開啟Oracle"/>
                            </form>
                            </div>
                        </div>
                    </div>
