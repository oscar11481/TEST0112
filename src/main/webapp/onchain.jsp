    ...
    <body>
        ...
        <nav class="navbar navbar-light bg-light static-top">
            <div class="container">
                ...
                <div class="col-md-1" >
                <a class="navbar-brand" href="insurer.jsp"><button class="btn btn-primary" href="signup.jsp" id="button-submit" type="button">監聽區塊鏈</button></a>
                </div>
                <div class="col-md-1" >
                <a class="navbar-brand" href="EOA.jsp"><button class="btn btn-primary" href="insurer.jsp" id="button-submit" type="button">設置醫療院所EOA</button></a>
                </div>
            </div>
        </nav>
        <!-- Masthead-->
                ...
                <div class="row justify-content-center">
                    <div class="col-xl-8">
                        <div class="text-center text-white">
                            ...
                            <h3 class="mb-5">歡迎使用本系統，請確認是否將合約上鏈</h3>
                            <div class="text-center text-white">
                                <div class="panel-heading"><h5>本次醫療保險類型:</h5>
                                ...
                                <input class="btn btn-primary" type ="submit" value="確認部屬合約"/>
                            </form>
                            </div>
                        </div>
                    </div>
